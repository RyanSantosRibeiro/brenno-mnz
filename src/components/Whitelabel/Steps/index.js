...
const Steps = () => {
    ...
    const active = (e) => {
        if($("#steps").offset().top - $(window).scrollTop() < (window.screen.height) && !$(".steps").hasClass("animate")) {
...
mensal, ficando com o seu lucro</p>
            ...
            {/* <div className="steps__highlight">
                <p className='steps__highlight__text'>Entre no <b>mundo virtual</b> e deixe sua marca ser descoberta por <span>milhões</span> de pessoas!</p>
            </div> */}
        </section>
    )
}
